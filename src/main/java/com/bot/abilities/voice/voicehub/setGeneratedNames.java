...
public class setGeneratedNames extends Command{
    ...
    @Override
    public String[] call() {
        return new String[] {"modifyGeneratedNames"};
    }
    ...
    public void onButtonInteraction(ButtonInteractionEvent e) {
        ...
        switch (Objects.requireNonNull(e.getButton().getId())) {
            case "help_yesNames" -> {
                EmbedBuilder eb = new EmbedBuilder();
                eb.setColor(Color.decode(config.get("color")));
                eb.setTitle("How do I modify the names generated by the voicehub? ", null);
                eb.setDescription("To change the names generated by voicehubs you have to execute: \n" +
                        "'" + prefix + "modifyGeneratedNames <#channelid> " +
                        "\n \n" +
                        "Replace _channelID_ with the id of the voicehub you want to edit");
                eb.setFooter("presented by " + config.get("bot_name"));
    ...
    public void onSelectMenuInteraction(SelectMenuInteractionEvent event) {
        ...
        if (Objects.equals(event.getComponent().getId(), "names")) {
            ...
            EmbedBuilder eb = new EmbedBuilder();
            eb.setColor(Color.decode(config.get("color")));
            eb.setTitle("The names generated by the voicehub have been successfully changed", null);
            eb.setDescription("\n\n");
            eb.setFooter("presented by " + config.get("bot_name"));
